			...
			<tbody>
				<c:forEach items="${boards}" var="board">
					<tr>
						...
						<td><a href="${contextPath}/board/detail.do?board_no=${board.board_no}">${board.title}</a>
						</td>
						<td>${board.create_date}</td>
						<td><a id="remove_link" href="${contextPath}/board/remove.do?board_no=${board.board_no}"><i class="fa-solid fa-x"></i> </a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
