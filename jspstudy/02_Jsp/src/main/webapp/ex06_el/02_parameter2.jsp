...
<%-- 	<div>${param.a - param.b <  0}, ${param.a - param.b lt 0}</div>
	...
	<div>${param.a - param.b >  0}, ${param.a - param.b gt 0}</div>
	<div>${param.a - param.b >= 0}, ${param.a - param.b ge 0}</div>
	<div>${param.a - param.b == 0}, ${param.a - param.b eq 0}</div>
	<div>${param.a - param.b != 0}, ${param.a - param.b ne 0}</div>
