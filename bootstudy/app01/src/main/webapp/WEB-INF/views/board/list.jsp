...
<style>
	...
	.show_new_icon {
		...
		width: 64px;
		height: 38px;
		background-image: url(../resources/images/like.png);
...
<body>
	...
	<div>
		<a href="/brd/write">새글작성</a>
	</div>

	<hr>

	<div>
		<form id="frm_list" action="/brd/remove/list" method="post">
			<div>
				<button>선택삭제</button>
			</div>
			<table border="1">
				...
				<tbody>
					<c:forEach items="${boards}" var="board">
						<tr>
							...
							<td>${board.boardNo}</td>
							<td>
								<a href="/brd/detail?boardNo=${board.boardNo}">${board.title}</a>
