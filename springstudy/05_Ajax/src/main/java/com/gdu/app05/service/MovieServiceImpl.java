...
public class MovieServiceImpl implements MovieService {
	...
	public String getBoxOffice(String targetDt) {
		...
		String key = "0b30210d57c1d07b9b8e5a600d00b56d";
		...
		try (BufferedReader reader = new BufferedReader(new InputStreamReader(con.getInputStream()))) { // try-catch-resources문은
																										// 자원의 close를
																										// 생략할 수 있다.
			String line = null;
