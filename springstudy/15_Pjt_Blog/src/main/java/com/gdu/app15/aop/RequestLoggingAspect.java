...
public class RequestLoggingAspect {
	...
	// 포인트컷 설정
	@Pointcut("within(com.gdu.app15.controller..*)")  // 컨트롤러의 모든 메소드를 포인트컷으로 지정하겠다.
	...
	@Around("com.gdu.app15.aop.RequestLoggingAspect.setPointCut()")  // setPointCut() 메소드에 설정된 포인트컷에서 동작하는 어드바이스
